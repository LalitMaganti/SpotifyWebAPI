...
public class RetrofitArtistComponent extends RetrofitBaseComponent implements ArtistComponent {

    private final SyncArtistAPI mSyncArtistAPI;

    public RetrofitArtistComponent() {
    ...
    private static interface SyncArtistAPI {
        ...
        public RetrofitTrackComponent.Tracks getTopTracks(@Path("id") final String artistId,
