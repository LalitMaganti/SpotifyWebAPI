...
public class RetrofitAlbumComponentTest {

    private final RetrofitAlbumComponent mClient;

    public RetrofitAlbumComponentTest() {
        mClient = new RetrofitAlbumComponent();
    }
