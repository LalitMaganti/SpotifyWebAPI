...
public class RetrofitArtistComponentTest {

    private final RetrofitArtistComponent mClient;

    public RetrofitArtistComponentTest() {
        mClient = new RetrofitArtistComponent();
    }
